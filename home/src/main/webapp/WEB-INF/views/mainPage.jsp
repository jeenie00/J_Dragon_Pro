...
<div class="main_body">
  ...
  <div id="modal_add_feed" class="modal modal_overlay">
	...
	<div id="modal_add_feed_centent" class="modal modal_overlay_content">
		<div class="modal_window">
			<div class="modal_title">
				<div class="modal_title_side"></div>
				<div style="margin: 5px;"> 새 게시물 </div>
				<div class="modal_title_side">
					<span id="close_modal" class="close_modal material-icons-outlined" style="cursor: pointer; font-size: 30px;">
						close
					</span>
				</div>
			</div>
			...
			<div class="modal_image_content">
				...
				<div class="madal_content_write">
					<div class="feed_name">
						<div class="profile_box">
							<img id="input_profile_image" class="profile_img"
							src="https://images.pexels.com/photos/7068253/pexels-photo-7068253.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
						</div>
							<span id="input_user_id" class="feed_name_txt">jeenie00</span>
					</div>
    ...
    function uploadFiles(e){
    	...
    	if(files[0].type.match(/image.*/)){
    		...
    		$('.modal_image_upload_content').css({
    			"boakground-image": "url("+window.URL.createObjectURL(files[0]) +")",
    			"outline":"none",
