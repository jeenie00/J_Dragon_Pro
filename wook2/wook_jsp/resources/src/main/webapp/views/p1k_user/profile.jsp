...
<%@ include file="../p1k_layout/header.jsp"%>
...
<section class="profile">
	...
	<div class="profileContainer">
		...
		<div class="profile-left">
			<div class="profile-img-wrap story-border" onclick="popup('.modal-image')"> <!--모델 팝업 이미지-->
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${dto.followState}">
								<button class="cta blue" onclick="followOrUnFollowProfile(${dto.user.id})"  id="follow_profile_btn">언팔로우</button>
							</c:when>
							<c:otherwise>
								<button class="cta" onclick="followOrUnFollowProfile(${dto.user.id})" id="follow_profile_btn">팔로우</button>
							</c:otherwise>
						</c:choose>
			...
			<div class="follow">
				<ul>
					...
					<li><a href="" id="subscribe_btn">
							팔로우 정보<span>${dto.followCount}</span>
						</a></li>
				</ul>
			</div>
			<div class="state">
...
<%@ include file="../p1k_layout/sidebar.jsp"%>